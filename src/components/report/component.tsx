    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 bg-gray-100 rounded-lg shadow-md extension-feature">
            <div className="space-y-4 text-center">
                ...
                <a href="https://github.com/ankitjha-webdev/SmartDailyReports" target="_blank" rel="noreferrer" title="Click to know more"><span className="text-red-400 hover:text-blue-600">Still in Development</span></a>
